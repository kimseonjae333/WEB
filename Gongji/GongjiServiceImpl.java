...
import kr.ac.kopo.ctc.kopo39.dao.GongjiDao;
import kr.ac.kopo.ctc.kopo39.dao.GongjiDaoImpl;
...
public class GongjiServiceImpl implements GongjiService {
	...
	public Pagination getPagination(int C, int countPerPage) { //인자값 받기
		...
		GongjiDao gongji = new GongjiDaoImpl(); //StudentScoreDaoImpl 객체 생성
		int total = gongji.count(); //StudentScoreDaoImpl의 count()함수 호출하여 리턴값 total에 저장
